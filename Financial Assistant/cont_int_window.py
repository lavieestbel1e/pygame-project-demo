...
class ContInterestWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.calc_button.clicked.connect(self.calculate_cont)
    ...
    def calculate_cont(self):
        ...
        if fv_value == 'x':
            x = sym.Symbol('x')
            solution = sym.solveset(((int(pv_value) * math.e ** ((float(pr_value) / 100) * int(n_value))) - x), x)
            self.parameter_input_4.setText(str(solution)[1:-1])
        elif pv_value == 'x':
            x = sym.Symbol('x')
            solution = sym.solveset(((x * math.e ** ((float(pr_value) / 100) * int(n_value))) - int(fv_value)), x)
            self.parameter_input.setText(str(solution)[1:-1])
        elif pr_value == 'x':
            x = sym.Symbol('x')
            solution = sym.solveset(((int(pv_value) * math.e ** ((x / 100) * int(n_value))) - int(fv_value)), x)
            self.parameter_input_2.setText(str(solution)[1:-1])
        elif n_value == 'x':
            x = sym.Symbol('x')
            solution = sym.solveset(((int(pv_value) * math.e ** ((float(pr_value) / 100) * x)) - int(fv_value)), x)
